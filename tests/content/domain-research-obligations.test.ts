...
const expectedOpenResearchObligations = [
  ...
  },
  {
    ...
    obligationType: "counterevidence",
    target: "case:south-carolina-reconstruction-political-membership#contest-and-transfer",
    status: "open",
  },
  {
    id: "sc-reconstruction-enforcement-deterrence-duration",
    obligationType: "counterevidence",
    target: "case:south-carolina-reconstruction-political-membership#federal-enforcement",
    status: "open",
  },
  {
  ...
  },
  {
    ...
    obligationType: "research-gap",
    target: "case:south-carolina-reconstruction-political-membership#changed-membership",
    status: "open",
  },
  {
    id: "sc-reconstruction-republican-coalition-division-1876",
    obligationType: "research-gap",
    target: "case:south-carolina-reconstruction-political-membership#comparisons-and-open-questions",
    status: "open",
  },
  {
    id: "sc-reconstruction-women-political-practice",
    obligationType: "research-gap",
    target: "case:south-carolina-reconstruction-political-membership#convention-arguments",
    status: "open",
  },
  {
