...
const documents: AuthoringDocument[] = [
  ...
  entity({ id: "test-case", kind: "case", label: "Test case", locationIds: ["test-place"], startDate: { year: 1900, certainty: "exact" }, endDate: { year: 2000, certainty: "exact" }, overviewTitle: "What is this case?", overview: [{ heading: "Overview", text: "Fixture.", statementIds: ["test-statement"] }], scope: "Fixture.", selectionRationale: "Fixture.", conditionStatementIds: [], episodeIds: ["test-before", "test-after"], ...base }),
