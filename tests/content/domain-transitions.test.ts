...
const documents: AuthoringDocument[] = [
  ...
  entity({ id: "test-case", kind: "case", label: "Test case", locationIds: ["test-place"], startDate: { year: 1900, certainty: "exact" }, endDate: { year: 2000, certainty: "exact" }, scope: "Fixture.", selectionRationale: "Fixture.", conditionStatementIds: [], episodeIds: ["test-before", "test-after"], ...base }),
  ...
  entity({ id: "test-event", kind: "event", label: "Institutional change", eventType: "institutional-change", locationIds: ["test-place"], startDate: { year: 1950, certainty: "exact" }, descriptionStatementIds: ["test-statement"], ...base }),
