...
const expectedCitationTuples = [
  ...
  ["jbg-formation-declaration", "ezln-thirteenth-stele-source", "supports", "section beginning “En suma, para cuidar…”; clause “se constituirán, el 9 de agosto del 2003…”"], ["jbg-formal-delegation", "ezln-thirteenth-stele-source", "supports", "section beginning “Sus sedes estarán…”; clause “estará formada por 1 ó 2 delegados…”"], ["jbg-formal-regional-functions", "ezln-thirteenth-stele-source", "supports", "list beginning “Para tratar de contrarrestar el desequilibrio…”"], ["jbg-formal-municipal-functions", "ezln-thirteenth-stele-source", "supports", "section beginning “Siguen siendo funciones exclusivas…”"], ["jbg-declared-ezln-oversight", "ezln-thirteenth-stele-source", "supports", "section beginning “El Comité Clandestino Revolucionario…”"],
  ...
  ["zapatista-2023-reorganization-declaration", "ezln-new-autonomy-structure-source", "supports", "sections “First”–“Fourth”; lead text “The main base…”"], ["zapatista-2023-caracoles-continuity", "ezln-new-autonomy-structure-source", "supports", "section “Third”; sentence beginning “They are based in the caracoles…”"], ["zapatista-2023-practice-open", "ezln-new-autonomy-structure-source", "supports", "introductory sentences beginning “I am going to try to explain…” and “At another time…”; section “Sixth”"],
...
describe("Zapatista caracol and Good Government Council case", () => {
  ...
  it("exposes challenge, criterion, research obligations, and canonical narrative without placeholders", () => {
    ...
    expect(dossier?.description).toBe("In 2003 the EZLN announced caracoles seating regional Good Government Councils composed of delegates from autonomous municipalities. Participant accounts described rotation, reporting, receipt-based accounting, and uneven participation; Andrews found council requirements that outside organizations accept community control over projects and resource allocation, while Gunderson argued that EZLN political-military authority continued. In 2023 the EZLN declared a shift to community-level Local Autonomous Governments, but their rules in use and outcomes remain unverified.");
    expect(dossier?.standfirstStatementIds).toEqual(["jbg-formation-declaration", "jbg-formal-delegation", "jbg-rotation-rules-in-use", "jbg-reporting-practice", "jbg-accounting-practice", "jbg-gender-participation-limit", "jbg-external-project-control", "zapatista-hybrid-authority-interpretation", "zapatista-2023-reorganization-declaration", "zapatista-2023-practice-open"]);
