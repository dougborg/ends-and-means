...
const boundaryDocuments: AuthoringDocument[] = [
  ...
  entity({ id: "test-democracy-case", kind: "case", label: "Test democracy case", locationIds: ["test-place"], startDate: { year: 2000, certainty: "exact" }, endDate: { year: 2001, certainty: "exact" }, scope: "Synthetic case scope.", selectionRationale: "Exercise role separation.", conditionStatementIds: [], episodeIds: ["test-democracy-episode"], ...base }),
...
describe("fiction and empirical evidence boundary", () => {
  ...
  it("applies the non-fiction support rule to criterion assessments", () => {
    const assessmentDocuments: AuthoringDocument[] = [
      ...
      entity({ id: "test-assessment-case", kind: "case", label: "Assessment case", locationIds: ["test-assessment-place"], startDate: { year: 2000, certainty: "exact" }, endDate: { year: 2001, certainty: "exact" }, scope: "Synthetic scope.", selectionRationale: "Exercise assessment evidence.", conditionStatementIds: [], episodeIds: [], ...base }),
