...
export const skillCapabilities: SkillCapability[] = [
  ...
  },
  {
    ...
    patterns: [
      ...
      /rebase merge rewrites commit|rebasing changes commit identifiers/i,
      /registered worktrees, standalone review clones, and exported review copies|registered worktrees, independent review clones and exported source copies/i,
      ...
      /retry normal removal; do not use blind forced removal|repeat ordinary removal; never force unreviewed deletion/i,
  ...
  },
  {
    ...
    paths: [`${researchRoot}/SKILL.md`],
    patterns: [
      /completed,\s*verified work[^.]+ready\s+pull request[^.]+by default/i,
