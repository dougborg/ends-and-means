...
const baseReviewedOrientationLedger: ReviewedOrientationDecision[] = [
  ...
  ...[
    ...
    "us-peoples-party-platform-episode",
    "peronist-formation-1943-1955",
    "first-peron-governments-episode",
    "zambia-pf-opposition-2001-2008",
    "zambia-pf-2006-campaign-episode",
    "thai-rak-thai-government-2001-2006",
    "thaksin-first-governments-episode",
    "welfare-state",
  ...
  ...["guide-nationalism", "guide-colonialism", "guide-imperialism"].map(
    (id) => ({
      targetType: "subject-guide" as const,
      id,
      disposition: "intentionally-unmatched" as const,
      references: [],
    }),
...
const reviewedMappingOverrides: Record<
  ...
  Omit<ReviewedOrientationDecision, "targetType" | "id">
> = {
  "entity:south-carolina": mapped(
    "South Carolina",
    "Q1456",
    "exact",
    "The article and Wikidata item directly identify the same United States state and constitutional jurisdiction.",
    "2026-09-08",
  ),
  "entity:south-carolina-upcountry": mapped(
    "Upstate South Carolina",
    "Q7899317",
    "close",
    "The article directly situates the inland South Carolina region, while the project Place follows the historical federal record's upcountry county scope rather than a fixed modern regional boundary.",
    "2026-09-08",
  ),
  "entity:hamburg-south-carolina": mapped(
    "Hamburg, South Carolina",
    "Q5644268",
    "exact",
    "The article and Wikidata item directly identify the same South Carolina settlement.",
    "2026-09-08",
  ),
  "entity:columbia-south-carolina": mapped(
    "Columbia, South Carolina",
    "Q38453",
    "exact",
    "The article and Wikidata item directly identify the same South Carolina capital city.",
    "2026-09-08",
  ),
  "entity:political-coercion": mapped(
    "Political violence",
    undefined,
    "close",
    "The article directly situates violence directed at political participation and control, while the project Concept is a narrower Event-kind boundary that also includes threats of force and makes no prevalence claim.",
    "2026-09-08",
  ),
  "entity:south-carolina-reconstruction-political-membership": mapped(
    "Reconstruction in South Carolina",
    undefined,
    "close",
    "The article directly situates Reconstruction institutions in South Carolina, while the project Case is limited to political membership, coercion, enforcement, and executive control from January 1868 through April 1877.",
    "2026-09-08",
  ),
  "entity:sc-constitution-formation-1868": mapped(
    "Reconstruction in South Carolina",
    undefined,
    "close",
    "The article directly situates the 1868 constitutional convention and constitution, while the project Episode separates convention adoption, elector ratification, and congressional admission through June 25.",
    "2026-09-08",
  ),
  "entity:sc-black-legislative-participation-1868-1876": mapped(
    "Reconstruction in South Carolina",
    undefined,
    "close",
    "The article directly situates Black officeholding during South Carolina Reconstruction, while the project Episode owns only the separately reported House and Senate majority periods.",
    "2026-09-08",
  ),
  "entity:sc-political-coercion-federal-enforcement-1871-1872": mapped(
    "South Carolina Ku Klux Klan trials of 1871–1872",
    undefined,
    "close",
    "The article directly situates the federal enforcement sequence, while the project Episode begins with Hill's dated May 1871 testimony and keeps later durability claims outside its November 1872 boundary.",
    "2026-09-08",
  ),
  "entity:sc-election-contest-office-transfer-1876-1877": mapped(
    "1876 South Carolina gubernatorial election",
    undefined,
    "close",
    "The article directly situates the disputed election, rival governments, and April 1877 transfer, while the project Episode begins with the July Hamburg confrontation and preserves conflicting casualty evidence.",
    "2026-09-08",
  ),
  "entity:sc-convention-adopted-constitution-event": mapped(
    "Reconstruction in South Carolina",
    undefined,
    "close",
    "The article directly situates the 1868 convention and constitution, while the project Event is only the convention's March 17 adoption act.",
    "2026-09-08",
  ),
  "entity:sc-elector-ratification-event": mapped(
    "Reconstruction in South Carolina",
    undefined,
    "close",
    "The article directly situates the 1868 constitution, while the project Event is the separately certified April 14–16 elector ratification vote.",
    "2026-09-08",
  ),
  "entity:sc-congressional-admission-event": mapped(
    "Reconstruction in South Carolina",
    undefined,
    "close",
    "The article directly situates South Carolina's Reconstruction, while the project Event is only Congress's June 25, 1868 conditional admission action.",
    "2026-09-08",
  ),
  "entity:sc-habeas-suspension-event": mapped(
    "South Carolina Ku Klux Klan trials of 1871–1872",
    undefined,
    "close",
    "The article directly describes Grant's October 1871 suspension in nine South Carolina counties, while the project Event records only that dated federal action.",
    "2026-09-08",
  ),
  "entity:sc-hamburg-confrontation-event": mapped(
    "Hamburg massacre",
    undefined,
    "close",
    "The article directly situates the July 1876 Hamburg violence, while the project Event owns only the July 8 confrontation and leaves the overnight casualty sequence in the broader Episode.",
    "2026-09-08",
  ),
  "entity:sc-rifle-club-disband-order-event": mapped(
    "1876 South Carolina gubernatorial election",
    undefined,
    "close",
    "The article directly situates rifle clubs and the 1876 contest, while the project Event records only Grant's October 17 disband order.",
    "2026-09-08",
  ),
  "entity:sc-statehouse-troop-withdrawal-event": mapped(
    "1876 South Carolina gubernatorial election",
    undefined,
    "close",
    "The article directly situates the federal troop decision in the disputed election's aftermath, while the project Event records the April 10 State House withdrawal separately from the next day's office transfer.",
    "2026-09-08",
  ),
  "entity:sc-executive-office-transfer-event": mapped(
    "1876 South Carolina gubernatorial election",
    undefined,
    "close",
    "The article directly situates the rival governments and April 1877 outcome, while the project Event records only the formal April 11 executive-office transfer.",
    "2026-09-08",
  ),
  ...
  "entity:nationalism": mapped("Nationalism", "Q6235"),
  "entity:colonialism": mapped("Colonialism", "Q7167"),
  "entity:imperialism": mapped("Imperialism", "Q7260"),
  "entity:hawaiian-kingdom-islands": mapped("Hawaiian Islands", "Q192626"),
  "entity:bandung-indonesia": mapped("Bandung", "Q10389"),
  "entity:ghana-1957": mapped("Ghana", "Q117"),
...
for (const [guideId, subjectId] of [
  ...
  ["guide-nationalism", "nationalism"],
  ["guide-colonialism", "colonialism"],
  ["guide-imperialism", "imperialism"],
