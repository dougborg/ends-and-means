...
const dossier = attachNarrative("zapatista-caracoles.md", {
  ...
  sections: [
    {
      id: "what-is-bounded",
      heading: "What is this case about?",
      body: "",
      ...
      relatedEntityRefs: [
        { kind: "concept" as const, id: "indigenous-autonomy" },
        {
    ...
    {
      id: "what-changed-in-2003",
      heading: "What changed in 2003?",
      body: "",
      ...
      relatedEntityRefs: [
        ...
        { kind: "organization" as const, id: "zapatista-caracoles" },
        {
          kind: "organization" as const,
    ...
    {
      id: "how-did-it-work",
      heading: "How did the councils work in practice?",
      body: "",
      traceStatus: "qualified" as const,
      statementIds: [
        "jbg-rotation-rules-in-use",
      ...
      relatedEntityRefs: [
        { kind: "means" as const, id: "rotating-municipal-delegation" },
        { kind: "challenge" as const, id: "authority-and-accountability" },
        { kind: "criterion" as const, id: "affected-community-accountability" },
      ],
    },
    {
      id: "what-changed-in-2023",
...
export const zapatistaCaracolesDossierDocuments = [
