...
const dossier = attachNarrative("zapatista-caracoles.md", {
  ...
  sections: [
    { id: "what-is-bounded", heading: "What is this case about?", body: "", traceStatus: "qualified" as const, statementIds: ["zapatista-autonomy-indigenous-context", "zapatista-reach-limit", "zapatista-anarchism-boundary"], relatedEntityRefs: [{ kind: "concept" as const, id: "indigenous-autonomy" }, { kind: "organization" as const, id: "zapatista-army-national-liberation" }, { kind: "organization" as const, id: "zapatista-support-base-communities" }] },
    { id: "what-changed-in-2003", heading: "What changed in 2003?", body: "", traceStatus: "supported" as const, statementIds: ["jbg-formation-declaration", "jbg-formal-delegation", "jbg-formal-division-of-functions", "jbg-declared-ezln-oversight"], relatedEntityRefs: [{ kind: "event" as const, id: "zapatista-caracoles-jbg-formation-2003" }, { kind: "organization" as const, id: "zapatista-caracoles" }, { kind: "organization" as const, id: "zapatista-good-government-councils" }] },
    { id: "how-did-it-work", heading: "How did the councils work in practice?", body: "", traceStatus: "qualified" as const, statementIds: ["jbg-rotation-rules-in-use", "jbg-external-project-control", "jbg-gender-participation-limit", "jbg-civil-military-authority-limit", "zapatista-accountability-assessment"], relatedEntityRefs: [{ kind: "means" as const, id: "rotating-municipal-delegation" }, { kind: "challenge" as const, id: "authority-and-accountability" }, { kind: "criterion" as const, id: "affected-community-accountability" }] },
