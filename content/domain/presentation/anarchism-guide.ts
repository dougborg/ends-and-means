...
const syndicalism = attachNarrative("anarcho-syndicalism.md", {
  ...
  description: "Rocker presents revolutionary unions as institutions that defend workers under existing conditions and prepare federated administration of production. This is one disputed strategy among several documented within historical anarchism.",
...
const tradition = attachNarrative("anarcho-syndicalism-tradition.md", {
  ...
  description: "Rocker situates modern anarcho-syndicalism within libertarian or anarchist socialism and gives revolutionary unions both defensive and transformative aims. That historical tradition must remain distinct from the specific organizing approach it proposes.",
