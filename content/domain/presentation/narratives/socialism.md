...
Pablo Gilabert and Martin O'Neill distinguish socialism from capitalism by asking whether the bulk of productive resources is under effective social and democratic control.
Public ownership alone does not answer that question: if people engaged in economic life cannot control the state or its assets, they classify the arrangement as statism rather than socialism.

## why-is-the-term-so-broad

Socialists can share values while disagreeing about the society, institutions, and political strategy those values require.
Michael Newman identifies equality, solidarity, cooperation, and conscious human agency as recurring commitments, but his history also follows different relationships with communism, social democracy, gender, ethnicity, and environmental movements across places and periods.
The label therefore names a field of arguments, not a complete institutional plan.
