...
A market is an institution for recurring exchange, not just any transfer between two people.
Calling an economy market-based does not establish who owns productive assets.
Economies can combine markets with other allocation mechanisms.
The label does not by itself mean capitalism or laissez-faire.
...
Agrarian England supplies a contested account centered on agrarian class relations.
In the Gold Coast, African producers shifted resources from existing market activities into cocoa.
In China after 1978, enterprise autonomy and market entry expanded while planning continued.
The cases differ sharply and should not be collapsed into one transition story.

## what-market-labels-leave-open

The label *market economy* leaves ownership unresolved.
It also leaves internal firm coordination and employment authority unresolved.
Regulation does not by itself make an economy non-market.
