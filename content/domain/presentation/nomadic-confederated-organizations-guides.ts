    ...
    guide: {
      ...
      sections: [
        ...
        },
        {
          ...
          heading: "Whose names and classifications are these?",
          narrativeRefs: [
            {
              dossierId: "ruwalla-borderland-organization-dossier",
        ...
        },
        {
          ...
          heading: "How did leadership, mobility, and resource access connect?",
          narrativeRefs: [
            {
              dossierId: "ruwalla-borderland-organization-dossier",
              sectionId: "how-did-leadership-work",
            },
            {
              dossierId: "ruwalla-borderland-organization-dossier",
              sectionId: "why-did-mobility-and-territory-matter",
            },
          ],
        },
        {
          ...
          heading: "What happened during the post-Ottoman border settlement?",
          narrativeRefs: [
            {
              dossierId: "ruwalla-borderland-organization-dossier",
              sectionId: "how-did-new-states-change-the-relationship",
            },
          ],
          entityRefs: [
            { kind: "case", id: "ruwalla-borderland-organization" },
            { kind: "case-episode", id: "ruwalla-borderland-1918-1936" },
          ],
        },
        {
          id: "variants-disputes-and-limits",
          role: "variants-and-disputes",
          heading: "Whose voices do the sources preserve?",
          narrativeRefs: [
            {
              dossierId: "ruwalla-borderland-organization-dossier",
        ...
        },
        {
          ...
          heading: "What makes comparison responsible?",
          narrativeRefs: [
            {
              dossierId: "ruwalla-borderland-organization-dossier",
              sectionId: "how-should-this-case-be-compared",
            },
          ],
          statementIds: ["ruwalla-jinst-non-equivalence"],
        },
        {
          id: "open-questions",
          role: "open-questions",
    ...
    guide: {
      ...
      sections: [
        ...
        },
        {
          id: "meanings-and-boundaries",
          role: "meanings-and-boundaries",
          heading: "Which groups and boundaries did the evidence identify?",
          narrativeRefs: [
            {
              dossierId: "jinst-postcollective-pastoral-governance-dossier",
              sectionId: "whose-terms-and-boundaries-apply",
            },
          ],
          statementIds: ["study-sites-neg-nutgiinkhan-boundary"],
        },
        {
          id: "institutions-and-mechanisms",
          role: "institutions-and-mechanisms",
          heading: "How did households coordinate different resources?",
          narrativeRefs: [
            {
              dossierId: "jinst-postcollective-pastoral-governance-dossier",
              sectionId: "how-were-resources-coordinated",
            },
            {
              dossierId: "jinst-postcollective-pastoral-governance-dossier",
              sectionId: "why-were-boundaries-permeable",
            },
          ],
        },
        {
          id: "bounded-practice",
          role: "bounded-practice",
          heading: "What does the 1990–1999 evidence distinguish?",
          narrativeRefs: [
            {
              dossierId: "jinst-postcollective-pastoral-governance-dossier",
              sectionId: "what-changed-after-the-collectives",
            },
          ],
          entityRefs: [
            { kind: "case", id: "jinst-postcollective-pastoral-governance" },
            { kind: "case-episode", id: "jinst-transition-1990-1999" },
          ],
        },
        {
          id: "variants-disputes-and-limits",
          role: "variants-and-disputes",
          heading: "Whose access was secure, and what does the study not show?",
          narrativeRefs: [
            {
              dossierId: "jinst-postcollective-pastoral-governance-dossier",
              sectionId: "whose-access-was-secure",
            },
            {
              dossierId: "jinst-postcollective-pastoral-governance-dossier",
              sectionId: "what-does-the-evidence-not-show",
            },
          ],
        },
        {
