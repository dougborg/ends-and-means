...
const dossier = attachNarrative("central-planning.md", {
  ...
  description:
    "Central planning coordinates a substantial range of decisions through authorized plans, but the label does not determine an ideology or ownership system. The United States Controlled Materials Plan allocated steel, copper, and aluminum during a bounded wartime period.",
...
const approachDossier = attachNarrative("us-wartime-production-mobilization.md", {
  ...
  description: "The Controlled Materials Plan allocated selected industrial materials through public claimant agencies, contractors, and producers from 1943 until September 1945. It was one part of wartime mobilization, not a plan for every good or economic decision.",
...
export const centralPlanningGuideDocuments = [
  ...
  { documentType: "entity", entity: approachDossier },
  {
    ...
    guide: {
      ...
      description: "Central planning covers institutional arrangements in which public authorities set and revise priorities for allocating resources; it does not by itself specify an ideology or ownership system. The United States Controlled Materials Plan shows one wartime design, while rival accounts leave its performance and distribution of power unsettled.",
