...
export const relationshipDocuments = [
  {
    ...
    relationships: [
      ...
      { id: "wage-earner-program-interprets-economic-democracy", predicate: "interprets-concept", subject: { kind: "approach", id: "swedish-wage-earner-fund-program" }, object: { kind: "concept", id: "economic-democracy" }, role: "core", interpretation: "The program sought greater wage-earner influence through collective shareholding, although the enacted caps left its practical contribution to economic democracy limited.", status: "qualified", statementIds: ["funds-related-ideas-classification", "funds-limited-control"] },
      { id: "wage-earner-program-interprets-social-ownership", predicate: "interprets-concept", subject: { kind: "approach", id: "swedish-wage-earner-fund-program" }, object: { kind: "concept", id: "social-ownership" }, role: "adjacent", interpretation: "Collective equity holdings connect the design to social-ownership proposals, but statutory title and wage-earner influence did not amount to controlling ownership.", status: "qualified", statementIds: ["funds-related-ideas-classification", "funds-limited-control"] },
      { id: "wage-earner-program-interprets-market-socialism", predicate: "interprets-concept", subject: { kind: "approach", id: "swedish-wage-earner-fund-program" }, object: { kind: "concept", id: "market-socialism" }, role: "contested", interpretation: "The use of collective investment inside a continuing market economy makes market socialism a useful comparison, not a settled classification of the enacted compromise.", status: "qualified", statementIds: ["funds-related-ideas-classification", "funds-partial-instantiation"] },
