...
export const nomadicConfederatedOrganizationResearchDocuments = [
  ...
  },
  {
    ...
    entity: {
      ...
      description: "A transfer-limit question about later tenure and pasture-user institutions.",
      obligationType: "research-gap",
      question: "Which Jinst pasture practices persisted, changed, or ended after the 1999 resurvey as later formal associations, markets, and climate pressures developed?",
      target: { kind: "case", id: "jinst-postcollective-pastoral-governance" },
      addressedStatementIds: ["jinst-fieldwork-provenance", "jinst-case-transfer-limit"],
